...
export const WEDDING_DATE = dayjs.tz("2026-09-12 13:00", "Asia/Seoul")
...
export const LOCATION = "삼성전자 서초사옥 (5층 다목적홀)"
export const LOCATION_ADDRESS = "서울특별시 서초구 서초대로74길 11"
...
export const BRIDE_FULLNAME = "윤채원"
export const BRIDE_FIRSTNAME = "채원"
// export const BRIDE_TITLE = "장녀"
export const BRIDE_FATHER = "윤재경"
export const BRIDE_MOTHER = "공명아"
export const BRIDE_INFO = [
  {
    relation: "신부",
    name: BRIDE_FULLNAME,
    phone: "010-6335-6095",
    account: "신한은행 110237552513",
  },
  {
    relation: "신부 아버지",
    name: BRIDE_FATHER,
...
export const GROOM_FULLNAME = "최해성"
export const GROOM_FIRSTNAME = "해성"
// export const GROOM_TITLE = "차남"
export const GROOM_FATHER = "최교선"
export const GROOM_MOTHER = "구지영"
